...
class _TyreScreenState extends State<TyreScreen> {
  ...
  // ---------- Tyre CRUD ----------
  Future<void> _addTyre(Vehicle vehicle) async {
    ...
    if (tyre != null) {
      ...
      await _loadCompaniesAndVehicles();
      setState(() {});
      _showSnack('Tyre ${tyre.tyreId} added');
    }
  }
  ...
  Future<void> _updateTyre(Tyre tyre, Vehicle parentVehicle) async {
    ...
    if (updated != null) {
      ...
      await _loadCompaniesAndVehicles();
      setState(() {});
      _showSnack('Tyre updated');
    }
  }

  Future<void> _deleteTyre(Tyre tyre) async {
